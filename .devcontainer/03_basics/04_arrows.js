...
// function chai(){
//     let username = "sharma"
//     console.log(this.username);//username will be undefined here //this can be used in objects but not in functions
// }
// chai()
...
const chai = () => {
    let username = "sharma"
    console.log(this);//{}
    console.log(this.username);//undefined//We cannot use this also in arrow function
}
chai()
...
// const add = (num1,num2) => ({username:"Tanish"})//object will be returned by using ({username:"tanish"}) like this 
