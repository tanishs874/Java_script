...
const jsUser = {
    name : "Tanish",
    "full name" : "Tanish sharma",//We cannot acces this value with using dot.So,we need to use square notation console.log(jsUser["full name"])
    mysymbol : "key1",//It will give the output as key1 but the typeof this will be string
    [mysymbol]: "key23",//Now it will give the output as key2 and the typeof will also be symbol
    age:20,
    location:"Ambala",
    email:"Ts@google.com",
    isloggedin:false,
